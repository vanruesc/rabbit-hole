/**
 * rabbit-hole v0.0.0 build Nov 27 2016
...
(function (global, factory) {
	...
	class MeshTriplanarStandardMaterial extends three.ShaderMaterial {
		...
		constructor() {
			...
			const source = three.ShaderLib.standard.uniforms;
	...
	class ThreadPool extends three.EventDispatcher {
	...
	class VoxelBlock extends Octree {
		...
		construct(chunk) {
			...
			const intersection = new Vector3$2();
			const edge = new Edge();
	...
	exports.MeshTriplanarStandardMaterial = MeshTriplanarStandardMaterial;
