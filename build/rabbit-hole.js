/**
 * rabbit-hole v0.0.0 build Apr 19 2018
  		...
  		createClass(Edge, [{
  				...
  				value: function approximateZeroCrossing(sdf) {
  						...
  						while (i <= s) {
  								...
  								p$1.addVectors(this.a, v$7.copy(ab).multiplyScalar(c));
  								...
  								if (Math.abs(densityC) <= ISOVALUE_BIAS || (b - a) / 2 <= INTERVAL_THRESHOLD) {
  										...
  										p$1.addVectors(this.a, v$7.copy(ab).multiplyScalar(a));
  				...
  				value: function computeSurfaceNormal(sdf) {
  						...
  						var dx = sdf.sample(p$1.addVectors(position, v$7.set(E, 0, 0))) - sdf.sample(p$1.subVectors(position, v$7.set(E, 0, 0)));
  						var dy = sdf.sample(p$1.addVectors(position, v$7.set(0, E, 0))) - sdf.sample(p$1.subVectors(position, v$7.set(0, E, 0)));
  						var dz = sdf.sample(p$1.addVectors(position, v$7.set(0, 0, E))) - sdf.sample(p$1.subVectors(position, v$7.set(0, 0, E)));
