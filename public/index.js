(function (three,dat,Stats) {
        ...
        */
          ...
          */
     				...
     				value: function raycast(raycaster, intersects) {
     						...
     						get(PointOctree.prototype.__proto__ || Object.getPrototypeOf(PointOctree.prototype), "raycast", this).call(this, raycaster, octants);
     ...
     var VolumeIterator = function () {
     		function VolumeIterator(volume) {
     				var cull = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
     				classCallCheck(this, VolumeIterator);
        ...
        */
     		...
     		createClass(VolumeIterator, [{
     				key: "reset",
     				value: function reset() {

     						var root = this.volume.root;
     						...
     						while (octant === null && i >= 0) {
     								...
     								if (index < 8) {
     										...
     										if (children !== null) {
     												...
     												if (!cull || region.intersectsBox(BOX3$1)) {
     ...
     var Volume = function (_Octree) {
       ...
       */
        ...
        */
     		...
     		key: "chunks",
     		value: function chunks(region) {

     			var iterator = new VolumeIterator(this, true);
     ...
     var Terrain = function (_EventTarget) {
          ...
          */
     				...
     				_this.iterator = _this.volume.chunks();
