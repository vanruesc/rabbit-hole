(function (three,dat,Stats) {
     ...
     var Detector = function Detector() {
       ...
       */
     	...
     	this.webgl = this.canvas ? function () {
     		...
     		var supported = window.WebGLRenderingContext !== undefined;
     		var canvas = void 0,
     		    context = void 0;
       ...
       */
     	...
     	this.file = window.File !== undefined && window.FileReader !== undefined && window.FileList !== undefined && window.Blob !== undefined;
     };
       ...
       */
     	...
     	createClass(Scheduler, [{
     		...
     		value: function cancel(element) {
     			...
     			var task = this.registry.get(element);
        ...
        */
     		...
     		value: function poll() {
     			...
     			var element = get$1(Scheduler.prototype.__proto__ || Object.getPrototypeOf(Scheduler.prototype), "poll", this).call(this);
        ...
        */
     		...
     		value: function clear() {
     			...
     			get$1(Scheduler.prototype.__proto__ || Object.getPrototypeOf(Scheduler.prototype), "clear", this).call(this);
     ...
     var MeshTriplanarPhysicalMaterial = function (_ShaderMaterial) {
     		...
     		function MeshTriplanarPhysicalMaterial() {
     				...
     				Object.keys(source).forEach(function (key) {
     						...
     						var uniform = new three.Uniform(source[key].value);
     ...
     var Chunk = function (_CubicOctant) {
       ...
       */
        ...
        */
     		...
     		key: "deserialise",
     		value: function deserialise(chunk) {
     				...
     				while (heap.length > 0) {
     					...
     					if (region.intersectsBox(octant)) {
     						...
     						if (children !== null) {
     							...
     							octant.split();
     							heap.push.apply(heap, toConsumableArray(octant.children));
     						} else {
     ...
     var SignedDistanceFunction = function () {
     		function SignedDistanceFunction(type) {
     				var material = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Density.SOLID;
        ...
        */
          ...
          */
     				...
     				value: function serialise() {
     						...
     						var result = get$1(Sphere.prototype.__proto__ || Object.getPrototypeOf(Sphere.prototype), "serialise", this).call(this);
        ...
        */
          ...
          */
     				...
     				value: function serialise() {
     						...
     						var result = get$1(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), "serialise", this).call(this);
       ...
       */
        ...
        */
     		...
     		value: function serialise() {
     			...
     			var result = get$1(Plane.prototype.__proto__ || Object.getPrototypeOf(Plane.prototype), "serialise", this).call(this);
        ...
        */
          ...
          */
     				...
     				value: function serialise() {
     						...
     						var result = get$1(Torus.prototype.__proto__ || Object.getPrototypeOf(Torus.prototype), "serialise", this).call(this);
        ...
        */
          ...
          */
     				...
     				value: function serialise() {
     						...
     						var result = get$1(Heightfield.prototype.__proto__ || Object.getPrototypeOf(Heightfield.prototype), "serialise", this).call(this);
     ...
     var Terrain = function (_EventTarget) {
          ...
          */
     				...
     				_this.levels = Math.log2(_this.volume.resolution);
        ...
        */
          ...
          */
     				...
     				value: function update(camera) {
     						...
     						var chunks = this.volume.cull(FRUSTUM.setFromMatrix(MATRIX4.multiplyMatrices(camera.projectionMatrix, camera.matrixWorldInverse)));
     ...
     function update$1(chunk, operation, data0, data1) {
     ...
     function execute(chunk, operation) {
     	...
     	if (operation.type === OperationType.DENSITY_FUNCTION) {
     		...
     		// Use the density function to generate data.
     		update$1(chunk, operation, result);
     	}
     	...
     	for (i = 0, l = children.length; i < l; ++i) {
     		...
     		if (result === undefined) {
     			...
     			if (result === null) {
     				...
     				// Combine the two data sets.
     				update$1(chunk, operation, result, data);
     			}
     		} else if (operation.type === OperationType.INTERSECTION) {
        ...
        */
     		...
     		value: function run(chunk, sdf) {
     			...
     			if (data !== null) {
     				...
     				// Step 2.
     				update$1(chunk, operation, chunk.data, data);
     ...
     var App = function () {
          ...
          */
     				...
     				value: function initialise(viewport, aside, assets) {
     						...
     						scene.fog = new three.FogExp2(0xeeeeee, 0.0025);
