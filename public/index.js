(function (three,dat,Stats) {
	...
	class OctreeHelper$1 extends three.Object3D {
	...
	class Editor {
		...
		constructor(terrain, camera, dom = document.body) {
			...
			this.octreeHelper = new OctreeHelper$1(this.terrain.volume);
