(function (three,dat,Stats) {
  ...
  var Heightfield = function (_SignedDistanceFuncti) {
  		...
  		function Heightfield() {
  				...
  				_this.size = new (Function.prototype.bind.apply(Vector3, [null].concat(toConsumableArray(parameters.size))))();

  				_this.scale = new (Function.prototype.bind.apply(Vector3, [null].concat(toConsumableArray(parameters.scale))))();
  ...
  var WorldOctreeCSG = function () {
  	...
  	createClass(WorldOctreeCSG, null, [{
  		...
  		value: function applyCSG(world, sdf) {
  			var region = b0.copy(sdf.completeBoundingBox);
