(function (three,dat,Stats) {
  ...
  var Heightfield = function (_SignedDistanceFuncti) {
  		...
  		function Heightfield() {
  				...
  				_this.size = new (Function.prototype.bind.apply(Vector3$1, [null].concat(toConsumableArray(parameters.size))))();

  				_this.scale = new (Function.prototype.bind.apply(Vector3$1, [null].concat(toConsumableArray(parameters.scale))))();
  ...
  var QEFDemo = function (_Demo) {
  		...
  		function QEFDemo() {
  				...
  				var _this = possibleConstructorReturn(this, (QEFDemo.__proto__ || Object.getPrototypeOf(QEFDemo)).call(this, "qef"));
  		...
  		createClass(QEFDemo, [{
  				...
  				value: function registerOptions(menu) {
  						...
  						var folder = menu.addFolder("Result");
  ...
  var SVODemo = function (_Demo) {
  		inherits(SVODemo, _Demo);

  		function SVODemo() {
  				classCallCheck(this, SVODemo);

  				var _this = possibleConstructorReturn(this, (SVODemo.__proto__ || Object.getPrototypeOf(SVODemo)).call(this, "svo"));
  		...
  		createClass(SVODemo, [{
  				...
  				value: function createHermiteData() {
  						...
  						var sdf = SuperPrimitive.create(preset);
  				...
  				value: function contour() {
  						...
  						if (isosurface !== null) {
  								...
  								mesh = new three.Mesh(geometry, new three.MeshStandardMaterial({ color: 0xff0000 }));
  ...
  window.addEventListener("load", function main(event) {
  	...
  	manager.addDemo(new QEFDemo());
  	manager.addDemo(new SVODemo());
