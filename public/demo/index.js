    ...
    _createClass(ContouringDemo, [{
      ...
      value: function contour() {
        ...
        if (isosurface !== null) {
          ...
          geometry.setAttribute("position", new three.BufferAttribute(isosurface.positions, 3));
          geometry.setAttribute("normal", new three.BufferAttribute(isosurface.normals, 3));
